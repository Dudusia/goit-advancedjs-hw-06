...
```
cd existing_repo
git remote add origin https://gitlab.com/goit-uni/js-adv/goit-advancedjs-hw-06.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/goit-uni/js-adv/goit-advancedjs-hw-06/-/settings/integrations)
